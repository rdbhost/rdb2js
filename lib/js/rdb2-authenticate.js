...
(function(window, undefined) {
    ...
    function register_password_login(userid, password) {
        ...
        function _go() {
            ...
            var addLoginEntry = "\
    -- insert new user into auth.fedauth_accounts and auth.account_passwords tables. \n\
    -- \n\
    ...
    INSERT INTO auth.account_passwords (idx, password) \n\
          ...
          \n\
    -- select (to return to client) authentication details for new user.  \n\
    -- \n\
    ...
    function register_login_with_email(email) {
        ...
        function _go() {
            ...
            var addLoginEntry = "-- use function to register new user by their email\n " +
                                "SELECT 1 AS idx, email, body FROM auth.register_with_email(%(email)s::VARCHAR);";
...
(function(window) {
    ...
    /* fedauth_dialog - presents dialog box to user for registering new fedauth provider

       @param provider - name of provider 'Twitter', 'Facebook', etc
     */
    ...
    /* add_fedauth_entry - adds provider to auth.fedoauth_providers

     @paaram d - data, with 'provider', 'version', 'client_key', etc elements
     */
    ...
    /* add_password_table - creates password table
     */
    ...
    /* add_loginfails_table - creates loginfails
     */
    ...
    /* add_passwordlogin_function - creates pl/pgSQL function to log user in
     */
    ...
    /* add_register_with_email_function - creates new pl/pgSQL function
     */
