...
(function(window) {
    ...
    function add_password_table() {
        ...
        return Rdbhost.super()
                .query(createPasswordTable.replace(/\{0\}/g, make_roleid('p', Rdbhost.account_number())))
                .get_data();
    }
    ...
    function add_loginfails_table() {
        ...
        return Rdbhost.super()
            .query(createLoginFailsTable.replace(/\{0\}/g, make_roleid('p', Rdbhost.account_number())))
            .get_data();
    }
