...
(function (window, undefined) {
    ...
    var requestObjectPrototype = {
        ...
        listen: function(channels) {
            ...
            var idx = this.listen.idx = (this.listen.idx || 0);
            this.listen.idx += channels.length;
        ...
        broadcast: function(channel, msg) {
            ...
            this.broadcast.idx = (this.broadcast.idx || 0)+1;
            ...
            // Add this function to request-hooks, to be applied just
            //  before sending to server
            this.add_hook_pair(add_broadcast.bind(null, channel, this.broadcast.idx), undefined, 'broadcast', 0.71);
