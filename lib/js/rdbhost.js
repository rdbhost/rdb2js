...
(function (window, undefined) {
    ...
    var requestObjectPrototype = {
        ...
        listen: function(channel) {
            ...
            if (channel.inline_plus_params || channel.indexOf('"')>-1)
                throw new Error('channel must be simple name, without "');
            channel = new Bare_Marker(channel);

            this.listen.idx = (this.listen.idx || 0)+1;
            ...
            function add_listen(channel, i, this_) {
                ...
                namedParams['_listen_channel_{}'.replace('{}', i)] = channel;
                var subq = new Rdbhost.util.Subquery_Marker('LISTEN "%(_listen_channel_{})s"'.replace(/\{\}/g, i),
                                                            [], namedParams, 'no AS');
            ...
            this.add_hook_pair(add_listen.bind(null, channel, this.listen.idx), strip_listen, 'listen', 0.72);
