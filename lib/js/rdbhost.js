...
//     }
    ...
    function process_wrapped_vals(q0, args0, namedParams0, QUERY_KEY) {
        ...
        offset = idx = 0;
        q = q.replace(namedParmsTokenRe, function(match, nm, pos) {
        ...
        init: function(role) {
            ...
            function interpolate_wrapped(this_) {
                ...
                var q0 = this_.finalToSend.q,
                    args0 = this_.finalToSend.args,
                    namedParams0 = this_.finalToSend.namedParams;

                var res = process_wrapped_vals(q0, args0, namedParams0, this_.finalToSend.QUERY_KEY);
