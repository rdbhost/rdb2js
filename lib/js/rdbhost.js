...
(function (window, undefined) {
    ...
    function connect(host, acct) {
        ...
        ACCT = acct ? acct : host;
        PAGE_URL = 'http://devdemos.noservercoding.com/rdb2js/lib/partials/'; // todo - update this
    }
    ...
    */
    ...
    function prepare_json() {
        ...
        var this_ = this;
        _.each( this_.request_hooks, function(f) {
            f(this_);
        });
     ...
     */
    function raw_data_getter_http(url_formdata) {
     ...
     */
    function raw_data_getter_ws(json) {
