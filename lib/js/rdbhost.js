...
//     }
    ...
    function Subquery_Marker(this_, val) {
    ...
    var requestObjectPrototype = {
        ...
        init: function(role) {
            ...
            this.add_hook_pair(interpolate_wrapped, null, 'unwrap', 0.2);
        ...
        /* extract query - creates a SubQuery_Marker from request, and optionally, clears
         ...
         @param noclear - boolean, should request not be cleared
         */
        extract_query: function(clear) {

            var sq = new Subquery_Marker(this, this.q);
            if (clear) {
                delete this.q;
                delete this.args;
        ...
        listen: function(channel) {
            ...
            this.add_hook_pair(add_listen, strip_listen, 'listen', 0.1);
