...
(function (window, undefined) {
    ...
    function Subquery_Marker(q, args, namedParams, provide_as) {
    ...
    var requestObjectPrototype = {
        ...
        extract_query: function() {
            ...
            return new Subquery_Marker(this.q, this.args, this.namedParams, 'AS');
        },
        ...
        listen: function(channel) {
            ...
            function add_listen(channel, i, this_) {
                ...
                var subq = new Rdbhost.util.Subquery_Marker('LISTEN "%(_listen_channel_{})s"'.replace(/\{\}/g, i), [], namedParams);
        ...
        broadcast: function(channel, msg) {
            ...
            function add_broadcast(channel, i, this_) {
                ...
                var subq = new Subquery_Marker(broadcastQ, [], namedParams);
